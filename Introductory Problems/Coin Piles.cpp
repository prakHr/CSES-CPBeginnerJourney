...
// subtract 2 from max and 1 from min until max==min
//  - find the difference d then do min-d and max-2*d
// if min reaches zero before max catches up then return "NO"
// check if min and max==0 or a multiple of 3 then return "NO"
void Solution() {
	int a,b;
	cin>>a>>b;
