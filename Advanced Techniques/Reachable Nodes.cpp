...
vi adj[maxN];
queue<int> Q;
//idea:- 1.use bfs and track nodes with indegree=0 in queue
// and   2.use bitmasking where mask = ans[v]|=ans[u] where u is initial nodes with indegree 0
// and ans[v] is updated after each iteration
int32_t main() {
