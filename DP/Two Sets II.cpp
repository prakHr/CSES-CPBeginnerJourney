...
int dp[500005];
// s=sum of 1,2,3,...n= n*(n+1)/2
// to divide into two sets of equal s/2
// s should be even then we need to find
// all possible number of subsets such that
// sum of all 1,2,3,..n for one half sum s/2
// dp[j] where the j will store all the possible 
// value of sums and i will be numbers from 1,2,3,..,n-1
//Because by only considering numbers up to n-1, 
// we always put n in the second set, and 
// therefore only count each pair of sets once 
