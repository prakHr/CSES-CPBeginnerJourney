...
void Solution() {
	...
	up = down  = SegTree<int>(n);
//	build(1,1,n,tree);
//	build(1,1,n,tree2);
	FOR(i,1,n+1,1){
//		update(1,1,n,i,a[i]-i,tree);
//		update(1,1,n,i,a[i]+i,tree2);
		pull(i);
	}
	while(q--){
		int type;
...
//			a[idx]=val;
			p[idx]=val;
			pull(idx);
//			update(1,1,n,idx,a[idx]-idx,tree);
//			update(1,1,n,idx,a[idx]+idx,tree2);
		}
		else{
...
//			k--;
			...
			int U = up.qry(k,n)-k;
//			int D=query(1,1,n,1,k,tree)+k;
//			int U=query(1,1,n,k,n,tree2)-k;
			cout<<min(U,D)<<endl;
//			cout<<"U:"<<U<<" D:"<<D<<endl<<min(U,D)<<endl;
		}             
	}
